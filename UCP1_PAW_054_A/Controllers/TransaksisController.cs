...
namespace UCP1_PAW_054_A.Controllers
{
    public class TransaksisController : Controller
    {
        ...
        public TransaksisController(CasirContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.Transaksis.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("IdTransaksi,IdCustomer,IdProduk,TotalTransaksi")] Transaksi transaksi)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdTransaksi,IdCustomer,IdProduk,TotalTransaksi")] Transaksi transaksi)
        {
